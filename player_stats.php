...
<body class="text-gray-800 antialiased">
    ...
    <div class="max-w-screen-2xl mx-auto p-4 md:p-6 lg:p-8">
        ...
        <!-- Filter Section -->
        <div class="bg-white p-5 md:p-6 rounded-xl shadow-lg mb-8 sticky top-4 z-20 border border-gray-200/75">
            <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-x-4 gap-y-4 items-end">
                <div>
                    ...
                    <select name="season" id="season" class="w-full border-gray-300 rounded-md text-sm py-2 px-3">
                ...
                <div>
                    ...
                    <select name="team" id="team" class="w-full border-gray-300 rounded-md text-sm py-2 px-3">
                ...
                <div>
                    ...
                    <select name="pos" id="pos" class="w-full border-gray-300 rounded-md text-sm py-2 px-3">
                ...
                <div>
                    ...
                    <input type="text" name="playerName" id="playerName" class="w-full border-gray-300 rounded-md text-sm py-2 px-3" placeholder="e.g., LeBron James" value="<?= htmlspecialchars($filterPlayerName) ?>">
                </div>

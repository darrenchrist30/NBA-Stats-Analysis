...
} catch (MongoDB\Driver\Exception\ConnectionTimeoutException $e) { /* ... error handling ... */ die("..."); }
catch (MongoDB\Driver\Exception\AuthenticationException $e) { /* ... error handling ... */ die("..."); }
catch (MongoDB\Driver\Exception\Exception $e) { /* ... error handling ... */ die("..."); }
catch (Exception $e) { /* ... error handling ... */ die("..."); }
